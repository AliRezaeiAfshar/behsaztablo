module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        sans: ['iran-sharp', 'sans-serif'],
        // Headlines - Inter for modern engineering precision
        inter: ['Inter', 'sans-serif'],
        headline: ['Inter', 'sans-serif'],
        // Body - Source Serif 4 for technical readability
        serif: ['Source Serif 4', 'serif'],
        body: ['Source Serif 4', 'serif'],
        // Technical/Code - JetBrains Mono for specifications
      ...
      boxShadow: {
        'industrial': '0 10px 25px -5px rgba(0, 0, 0, 0.1)',
